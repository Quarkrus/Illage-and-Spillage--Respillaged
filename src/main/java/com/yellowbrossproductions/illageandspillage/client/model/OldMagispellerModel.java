...
public class OldMagispellerModel<T extends Entity> extends EntityModel<T> implements ArmedModel, HeadedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("illageandspillage", "old_magispeller"), "main");
    private final ModelPart body;
    private final ModelPart left_leg;
    private final ModelPart right_leg;

    public OldMagispellerModel(ModelPart root) {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        } else if (entity instanceof FakeMagispellerEntity magispeller) {
            AnimationUtils.swingWeaponDown(this.body.getChild("right_arm"), this.body.getChild("left_arm"), magispeller, this.attackTime, ageInTicks);
